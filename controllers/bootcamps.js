...
exports.updatebootcamp = asyncHandler(async (req,res,next) => {
    let bootcamp = await Bootcamp.findById(req.params.id)
        ...
        {
            return next(new ErrorResponse(`User ${req.user.id} is not authorized to update bootcamp`,401))
        }
...
exports.deletebootcamp = asyncHandler(async (req,res,next) => {
    ...
    if(!bootcamp)
    {
        ...
        if(bootcamp.user.toString() !== req.user.id && req.user.role !== 'admin')
        {
            return next(new ErrorResponse(`User ${req.user.id} is not authorized to delete bootcamp`,401))
        }
...
// @desc      Get Bottcamps within a radius
...
exports.getBootcampsInRadius = asyncHandler(async (req,res,next) => {
    ...
    // Earcth radius = 3,963 mi/ 6,378 km
